In this project, we developed two smart contracts based on ERC721 token. First contract is LegalEntityVerification.sol for State. This contract has 2 fields:
